...
> | Virtue | Brief Effect |
> |--------|-------------|
> | Elven-skill | Cultural Blessing (free) |
> | Folk of the Stars | Awareness and Scan rolls made at night are Favoured |
> | Fade | Once per combat, become difficult to target (enemy must reroll attack) |
> | Memory of Ancient Days | Lore and Riddle rolls about First Age events are Favoured |
> | Ancient Speech | Courtesy rolls with all Elven peoples are Favoured |
> | Gift of the Valar | Spend 2 Hope instead of 1 when Magical success triggers |
