...
> | Virtue | Brief Effect |
> |--------|-------------|
> | *(Blessing)* | See embedded PDF above |
> | Crossroads of the World | Insight and Persuade rolls in Bree-land are Favoured |
> | Common Sense | Once per session, re-roll a failed Insight roll |
> | Stout Hearts | Resist one Miserable condition per adventure without a test |
> | Trader's Eye | Persuade to assess value or barter is Favoured |
> | Unexpected Courage | Gain (1d) on the first attack roll of a combat you entered reluctantly |
