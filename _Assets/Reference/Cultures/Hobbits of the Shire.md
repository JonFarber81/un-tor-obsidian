...
> | Virtue | Brief Effect |
> |--------|-------------|
> | Hobbit-sense | Cultural Blessing (free) |
> | Smoking Accessories | Pipe-weed items grant bonuses to Hope/Resting |
> | Stout-hearted | Reduce Shadow gained from Terror tests |
> | The Shire Undefiled | If Fellowship Focus is another Hobbit, both gain bonuses |
> | Heirloom | Start with a useful item passed down through family |
> | Gift of Bilbo | Once per phase, recover 1 Hope on a successful Riddle roll |
